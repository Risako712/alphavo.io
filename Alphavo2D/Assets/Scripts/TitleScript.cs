...
public class TitleScript : MonoBehaviour {
	...
	void Start () {
		...
		GameObject.Find("STAR").GetComponent<UnityEngine.UI.Image>().enabled = false;
		GameObject.Find("PENCIL").GetComponent<UnityEngine.UI.Image>().enabled = false;
		GameObject.Find("alphavo").GetComponent<UnityEngine.UI.Text>().enabled = false;
	        ...
	        if (collider != null) {
        		...
        		if (boneAnime != null && Random.value > 0.3f) {
					...
					if (GameObject.FindWithTag("STUDY").GetComponent<UnityEngine.UI.Text>().enabled != true) {
						...
						GameObject.Find("STAR").GetComponent<UnityEngine.UI.Image>().enabled = true;
						GameObject.Find("PENCIL").GetComponent<UnityEngine.UI.Image>().enabled = true;
						GameObject.Find("alphavo").GetComponent<UnityEngine.UI.Text>().enabled = true;
						GameObject.Find("Canvas/touchme").GetComponent<UnityEngine.UI.Text>().enabled = false;
					}
